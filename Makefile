...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="vector_search" -DDUCKDB_OOT_EXTENSION_VECTOR_SEARCH_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_VECTOR_SEARCH_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_VECTOR_SEARCH_INCLUDE_PATH="$(PROJ_DIR)src/include"
